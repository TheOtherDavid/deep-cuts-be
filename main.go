...
func generateDeepCutPlaylist() func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		//Create playlist
		generatedPlaylistId := createPlaylist(ctx, client, user, finalTracks)
...
func createPlaylist(ctx context.Context, client *spotify.Client, user *spotify.PrivateUser, tracks []spotify.SimpleTrack) string {
